...
import "OpenZeppelin/openzeppelin-contracts@4.7.3/contracts/utils/cryptography/MerkleProof.sol";
...
/// @custom:security-contact svmorris@protonmail.com
contract BTD is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(string memory _placeholderTokenURI, bytes32 _merkleRoot, address[] memory _admins) payable ERC721("Bored To Death (test 0)", "BTD")
    {
